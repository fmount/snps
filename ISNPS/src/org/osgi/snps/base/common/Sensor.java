...
/*	@SuppressWarnings({ "unchecked", "unused", "rawtypes" })
	public void addSubs(BundleContext context){
		...
		addFilter(this.getID());
		System.out.println("[SUBSCRIBER "+this.getID()+"]: Create subs on topics: "+dict.get(EventConstants.EVENT_TOPIC).toString());
		sbs = new Subscriber(this.getID(),"sensdata",context);
	...
	public void updateFilter(String filter){
		removeFilter();
		addFilter(filter);
		System.out.println("[Sensor: "+this.getID()+"] -> Filter changed to: "+filter);
	}*/
}
